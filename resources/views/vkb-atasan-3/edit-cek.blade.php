                            ...
                            <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input  id="txtNameCard" name="po_vendor" type="text" class="form-control input-v"  value="{{$kasbon->po_vendor}}" disabled>
                                                    </div>
                                                </div><!--end form-group-->
                                            </div><!--end col-->
                                            <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 ">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input  id="txtNameCard" name="noinvoice" type="text" class="form-control input-noi"  value="{{$kasbon->noinvoice}}" disabled> 
                                                </div>
                                            </div><!--end form-group-->
                                        </div><!--end col-->
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input  id="txtNameCard" name="spph" type="text" class="form-control input-koi"  value="{{$kasbon->spph}}" disabled>
                                                </div>
                                            </div><!--end form-group-->
                                        </div><!--end col-->
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input  id="txtNameCard" name="nopi" type="text" class="form-control input-pi"  value="{{$kasbon->nopi}}" disabled>
                                                </div>
                                            </div><!--end form-group-->
                                        </div><!--end col-->
                                    </div>
                             ...
                             <div class="row mt-3">
                                <div class="col-sm-12 text-end">
                                    <a href="{{route('vkb-atasan-3.index')}}" class="btn btn-danger">Back</a>  
