                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body bootstrap-select-1">
                            {!! Form::model($kasbon, ['method' => 'PATCH','route' => ['vkb-atasan-3.update', $kasbon->id],'class' => 'form-parsley']) !!}
                                <input value="{{$kasbon->id}}" class="text-muted mb-0" name="id" hidden>
                                {{ csrf_field() }}
                               @include('vkb-atasan-3.edit-cek')
                               @include('vkb-atasan-3.edit-keterangan')
                               {!! Form::close() !!} 
                        </div><!--end card-body-->
                    </div><!--end card-->
                </div><!--end col-->
