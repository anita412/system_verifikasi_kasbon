            ...
            <div class="col-sm-12">
                <div class="card form-wizard-wrapper">
                    <div class="card-header">
                        <h4 class="card-title" id="1-form-entry">Form Edit Non Kasbon</h4>
                    </div><!--end card-header-->
                    <div class="card-body">
                        {!! Form::model($kelengkapan, ['method' => 'PATCH','route' => ['nonkasbon.update', $kelengkapan->kasbon->id],'class' => 'form-parsley']) !!}
                        {{ csrf_field() }}
