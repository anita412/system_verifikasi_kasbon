...
@endsection
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('li_3') Verifikasi Pertanggungan @endslot
                            ...
                            <table id="datatable2" class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($pertanggungan->verifikasipertanggungan->vkp_a_3 == "Terverifikasi" and $pertanggungan->verifikasipertanggungan->vkp_a_3 == "Terverifikasi")
                                        ...
                                        <label class="badge rounded-pill bg-danger">{{$pertanggungan->verifikasipertanggungan->vkp_a_3}}</label>
                                    ...
                                    <td>
                                        @if(isset($pertanggungan->verifikasipertanggungan->id_vkp_a_3))
                                        @include('vkp-atasan-3.modal-cek-edit')
                                        @include('vkp-atasan-3.modal-cek-lihat')
                                            @if($pertanggungan->verifikasipertanggungan->vkp_a_3 == "Dalam Proses")
                                        ...
                                        @include('vkp-atasan-3.modal-cek-edit')
                                            @if($pertanggungan->verifikasipertanggungan->vkp_a_3 == "Dalam Proses")
                                            <a class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalcekedit_{{$pertanggungan->id}}"><i class="mdi mdi-send me-2"></i>Lihat Kasbon</a>
                                            @elseif($pertanggungan->verifikasipertanggungan->vkp_a_3 == "Ditolak")
                                            ...
                                            @elseif($pertanggungan->verifikasipertanggungan->vkp_a_3 == "Revisi")
                                            <a class="btn btn-outline-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modalcekedit_{{$pertanggungan->id}}"><i class="mdi mdi-send me-2"></i>Lihat Kasbon</a>
                                            @endif
                                        @endif
                                    </td>
                                    @endforeach
