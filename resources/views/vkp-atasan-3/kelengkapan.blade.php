                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body bootstrap-select-1 form-wizard-wrapper">
                            <form  action="{{ route('verifikasipertanggungan.store', $pertanggungan->id) }}" method="post" class="form-parsley" >
                                <input value="{{$pertanggungan->id}}" class="text-muted mb-0" name="id" hidden>
                                {{ csrf_field() }}
                                @include('verifikasi-pertanggungan.cek')
                                @include('verifikasi-pertanggungan.dokumen-vendor')
                                @include('verifikasi-pertanggungan.dokumen-customer')
                                @include('verifikasi-pertanggungan.dokumen-impor')
                                @include('verifikasi-pertanggungan.dokumen-pajak')
                                @include('verifikasi-pertanggungan.dokumen-dinas')
                                @include('verifikasi-pertanggungan.keterangan')
                            </form>   
                        </div><!--end card-body-->
                    </div><!--end card-->
                </div><!--end col-->
