                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="1-form-entry">Show {{$nonkasbon->no_nonkasbon}}</h4>
                        ...
                        <div class="card-body bootstrap-select-1 form-wizard-wrapper">
                            {!! Form::model($nonkasbon, ['method' => 'PATCH','route' => ['vnk-atasan-2.update', $nonkasbon->id],'class' => 'form-parsley']) !!}
                                <input value="{{$nonkasbon->id}}" class="text-muted mb-0" name="id" hidden>
                                {{ csrf_field() }}
                               @include('vnk-atasan-2.edit-cek')
                               @include('vnk-atasan-2.edit-lembar-verifikasi')
                               @include('vnk-atasan-2.edit-keterangan')
                               {!! Form::close() !!} 
                        </div><!--end card-body-->
                    </div><!--end card-->
                </div><!--end col-->
