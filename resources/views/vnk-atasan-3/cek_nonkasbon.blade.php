                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body bootstrap-select-1 form-wizard-wrapper">
                            <form  action="{{ route('vnk-atasan-2.store', $nonkasbon->id) }}" method="post" class="form-parsley" >
                                <input value="{{$nonkasbon->id}}" class="text-muted mb-0" name="id" hidden>
                                {{ csrf_field() }}
                                @include('vnk-atasan-2.cek')
                                @include('vnk-atasan-2.lembar-verifikasi')
                                @include('vnk-atasan-2.keterangan')
                            </form>   
                        </div><!--end card-body-->
                    </div><!--end card-->
                </div><!--end col-->
