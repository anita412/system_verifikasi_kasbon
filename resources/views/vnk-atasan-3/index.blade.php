...
@endsection
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('li_3') Verifikasi Nonkasbon @endslot
                            ...
                            <table id="datatable2" class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tr>
                                    ...
                                    @if($nonkasbon->verifikasinonkasbon->vnk_a_3 == "Dalam Proses")
                                        ...
                                        @endif</td>
                                    <td >
                                        @if(isset($nonkasbon->verifikasinonkasbon->id_vnk_a_3))
                                        @include('vnk-atasan-3.modal-cek-edit')
                                        @include('vnk-atasan-3.modal-cek-lihat')
                                            @if($nonkasbon->verifikasinonkasbon->vnk_a_3 == "Dalam Proses")
                                            ...
                                            @endif
                                        @else
                                        @include('vnk-atasan-3.modal-cek')
                                            @if($nonkasbon->verifikasinonkasbon->vnk_a_3 == "Dalam Proses")
                                            ...
                                            @elseif($nonkasbon->verifikasinonkasbon->vnk_a_3 == "Terverifikasi")
                                            <a href={{ route('vnk-atasan-3.cek_nonkasbon',$nonkasbon->id) }} class="btn btn-outline-success btn-sm"><i class="mdi mdi-send me-2"></i>Lihat nonkasbon</a> 
                                            @elseif($nonkasbon->verifikasinonkasbon->vnk_a_3 == "Ditolak")
                                            <a href={{ route('vnk-atasan-3.cek_nonkasbon',$nonkasbon->id) }} class="btn btn-outline-danger btn-sm"><i class="mdi mdi-send me-2"></i>Lihat nonkasbon</a> 
                                            @elseif($nonkasbon->verifikasinonkasbon->vnk_a_3 == "Revisi")
                                            <a href={{ route('vnk-atasan-3.cek_nonkasbon',$nonkasbon->id) }} class="btn btn-outline-warning btn-sm"><i class="mdi mdi-send me-2"></i>Lihat nonkasbon</a> 
                                            @endif
                                        @endif
                                    </td>
                                    @endif
