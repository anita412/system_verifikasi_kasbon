                            ...
                            <table id="datatable2" class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($pertanggungan->verifikasipertanggungan->vkp_a_2 == "Terverifikasi" and $pertanggungan->verifikasipertanggungan->vkp_a_2 == "Terverifikasi")
                                    ...
                                    <td>
                                        @if(isset($pertanggungan->verifikasipertanggungan->id_vkp_a_2))
                                        @include('vkp-atasan-2.modal-cek-edit')
                                        @include('vkp-atasan-2.modal-cek-lihat')
                                            @if($pertanggungan->verifikasipertanggungan->vkp_a_2 == "Dalam Proses")
