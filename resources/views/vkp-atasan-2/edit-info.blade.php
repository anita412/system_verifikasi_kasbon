            ...
            <div class="col-sm-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="txtLastNameBilling" class="col-lg-4 col-form-label">Tanggal Masuk</label>
                                            <div class="col-lg-8">
                                                <input class="form-control" name="tglmasuk" type="date" value="{{$kasbon->tglmasuk}}" disabled>
                                            </div>
                                    </div>
                                </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" type="text" value="{{$kasbon->nokasbon}}" aria-label="Disabled input example" name="doksebelumnya" disabled readonly>
                                    </div>
                                </div><!--end form-group-->
                            </div><!--end col-->
                            <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input id="proyek" name="proyek" type="text" class="form-control" value="{{$kasbon->proyek}}" required disabled>
                                        </div>
                                    </div><!--end form-group-->
                                </div><!--end col-->
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea id="uraianpengguna" name="uraianpengguna" rows="4" class="form-control" required parsley value="" disabled>{{$kasbon->uraianpengguna}}</textarea>
                                        </div>
                                    </div><!--end form-group-->
                                </div><!--end col-->
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" value="{{$kasbon->jenis->name}}" aria-label="Disabled input example" id="kodekasbon" name="kodekasbon" disabled readonly>
                                        </div>
                                    </div><!--end form-group-->
                                </div><!--end col-->
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row" >
                                                ...
                                                <div class="col-lg-8">
                                                    <input  required parsley id="iddpp" type="number" class="form-control"  name="iddpp" onkeyup="add_number()" value="{{$kasbon->iddpp}}" disabled/>
                                                </div>
                                            </div><!--end form-group-->
                                        </div><!--end col-->
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input required parsley class="form-control input-numera" type="number" id="idppn" class="form-control"  name="idppn" value="{{$kasbon->idppn}}" onkeyup="add_number()" disabled/>
                                                        {{-- <script>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input class="form-control" type="text" value="{{$kasbon->pph->name}}" aria-label="Disabled input example" id="kodekasbon" name="kodekasbon" disabled readonly>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <input required parsley class="form-control input-numera" type="number" id="idpph" class="form-control"  name="idpph" value="{{$kasbon->idpph}}" onkeyup="add_number()" disabled/>
                                                    </div>
                                                </div><!--end form-group-->
                                            </div><!--end col-->
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input class="form-control input-numer" id="total" name="total" disabled value="{{$kasbon->total}}" disabled/>
                                                            {{-- <script>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input required parsley id="txtNameCard" name="sjn" type="text" class="form-control input-sj" data-parsley-minlength="17" value="{{$kasbon->sjn}}" disabled>
                                                        {{-- <script>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input required parsley class="form-control input-num" name="harga_jual" value="{{$kasbon->harga_jual}}" disabled/>
                                                        <script>
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-end mt-2" style="margin-top: -2rem">
                            ...
                            <a href="{{route('kelengkapan_edit',$kasbon->id)}}" class="btn btn-primary px-4">Next</a>
                            @else
