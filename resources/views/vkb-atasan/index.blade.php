                            ...
                            <table id="datatable2" class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($kasbon->verifikasikasbon->vkb_a_1 == "Terverifikasi" and $kasbon->verifikasikasbon->vkb_a_2 == "Terverifikasi")
                                        <label class="badge rounded-pill bg-success">Terverifikasi</label>
                                        @else
                                        <label class="badge rounded-pill bg-success">Menunggu Proses</label>
                                        @endif
                                    ...
                                    <td class="text-end">
                                        @if(isset($kasbon->verifikasikasbon->vkb_a_1))
                                        @if(isset($kasbon->verifikasikasbon->id_vkb_a_1))
                                            @if($kasbon->verifikasikasbon->vkb_a_1 == "Dalam Proses")
                                            <a href={{ route('vkb-atasan.cek_kasbon_edit',$kasbon->id) }} class="btn btn-outline-primary btn-sm"><i class="mdi mdi-send me-2"></i>Cek Kasbon</a> 
                                            @elseif($kasbon->verifikasikasbon->vkb_a_1 == "Terverifikasi")
                                            <a href={{ route('vkb-atasan.cek_kasbon_edit',$kasbon->id) }} class="btn btn-outline-success btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Kasbon</a> 
                                            @elseif($kasbon->verifikasikasbon->vkb_a_1 == "Ditolak")
                                            <a href={{ route('vkb-atasan.cek_kasbon_edit',$kasbon->id) }} class="btn btn-outline-danger btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Kasbon</a> 
                                            @elseif($kasbon->verifikasikasbon->vkb_a_1 == "Revisi")
                                            <a href={{ route('vkb-atasan.cek_kasbon_edit',$kasbon->id) }} class="btn btn-outline-warning btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Kasbon</a> 
                                            @endif
                                        @else
                                            @if($kasbon->verifikasikasbon->vkb_a_1 == "Dalam Proses")
                                            <a href={{ route('vkb-atasan.cek_kasbon',$kasbon->id) }} class="btn btn-outline-primary btn-sm"><i class="mdi mdi-send me-2"></i>Cek Kasbon</a> 
                                            @elseif($kasbon->verifikasikasbon->vkb_a_1 == "Terverifikasi")
                                            <a href={{ route('vkb-atasan.cek_kasbon',$kasbon->id) }} class="btn btn-outline-success btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Kasbon</a> 
                                            @elseif($kasbon->verifikasikasbon->vkb_a_1 == "Ditolak")
                                            <a href={{ route('vkb-atasan.cek_kasbon',$kasbon->id) }} class="btn btn-outline-danger btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Kasbon</a> 
                                            @elseif($kasbon->verifikasikasbon->vkb_a_1 == "Revisi")
                                            <a href={{ route('vkb-atasan.cek_kasbon',$kasbon->id) }} class="btn btn-outline-warning btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Kasbon</a> 
                                            @endif
                                        @endif
                                        @endif
                                    </td>
