                            ...
                            <table id="datatable2" class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @include('vkb-atasan.modal-cek-edit')
                                        @include('vkb-atasan.modal-cek-lihat')
                                            @if($kasbon->verifikasikasbon->vkb_a_1 == "Dalam Proses")
                                            ...
                                            @elseif($kasbon->verifikasikasbon->vkb_a_1 == "Revisi")
                                            <a class="btn btn-outline-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modalceklihat_{{$kasbon->id}}"><i class="mdi mdi-send me-2"></i>Lihat Kasbon</a> 
                                            @endif
                                        @else
                                        @include('vkb-atasan.modal-cek')
                                            @if($kasbon->verifikasikasbon->vkb_a_1 == "Dalam Proses")
