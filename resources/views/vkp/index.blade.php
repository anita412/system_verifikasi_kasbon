                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(isset($pertanggungan->verifikasipertanggungan->id_vkp))
                                            @if($pertanggungan->verifikasipertanggungan->vkp == "Dalam Proses")
                                            <a href={{ route('vkp.cek_pertanggungan_edit',$pertanggungan->id) }} class="btn btn-outline-primary btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Dokumen</a>
                                            @elseif($pertanggungan->verifikasipertanggungan->vkp == "Revisi")
                                            <a href={{ route('vkp.cek_pertanggungan_edit',$pertanggungan->id) }} class="btn btn-outline-warning btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Dokumen</a>
                                            @elseif($pertanggungan->verifikasipertanggungan->vkp == "Terverifikasi")
                                            <a href={{ route('vkp.cek_pertanggungan_edit',$pertanggungan->id) }} class="btn btn-outline-success btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Dokumen</a>
                                            @elseif($pertanggungan->verifikasipertanggungan->vkp == "Ditolak")
                                            <a href={{ route('vkp.cek_pertanggungan_edit',$pertanggungan->id) }} class="btn btn-outline-danger btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Dokumen</a>
                                            @endif
                                            @else
                                        @if($pertanggungan->verifikasipertanggungan->vkp == "Dalam Proses")
                                        <a href={{ route('vkp.cek_pertanggungan',$pertanggungan->id) }} class="btn btn-outline-primary btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Dokumen</a>
                                        @elseif($pertanggungan->verifikasipertanggungan->vkp == "Revisi")
                                        <a href={{ route('vkp.cek_pertanggungan',$pertanggungan->id) }} class="btn btn-outline-warning btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Dokumen</a>
                                        @elseif($pertanggungan->verifikasipertanggungan->vkp == "Terverifikasi")
                                         <a href={{ route('vkp.cek_pertanggungan',$pertanggungan->id) }} class="btn btn-outline-success btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Dokumen</a>
                                        @elseif($pertanggungan->verifikasipertanggungan->vkp == "Ditolak")
                                         <a href={{ route('vkp.cek_pertanggungan',$pertanggungan->id) }} class="btn btn-outline-danger btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Dokumen</a>
                                    @endif
                                    @endif
                                    </td>
                                    @endforeach
