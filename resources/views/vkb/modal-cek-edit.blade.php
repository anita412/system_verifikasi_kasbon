                                ...
                                <div class="card-body">
                                        <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="dv_packinglist" id="dv_packinglist1" value="ASLI" {{ ($kasbon->kelengkapan->dvendor->dv_packinglist=="ASLI")? "checked" : "" }}>
                                                        <label class="form-check-label" for="dv_packinglist1">
                                                            ASLI
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="dv_packinglist" id="dv_packinglist2" value="COPY" {{ ($kasbon->kelengkapan->dvendor->dv_packinglist=="COPY")? "checked" : "" }}> 
                                                        <label class="form-check-label" for="dv_packinglist2">
                                                            COPY
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="dv_packinglist" id="dv_packinglist2" value="-" {{ ($kasbon->kelengkapan->dvendor->dv_packinglist=="-")? "checked" : "" }}>
                                                        <label class="form-check-label" for="dv_packinglist2">
                                                            -
                                                        </label>
                                                    </div>
