                            ...
                            <table id="datatable2" class="table dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(isset($kasbon->verifikasikasbon->vkb_a_4))
                                        @if($kasbon->verifikasikasbon->vkb_a_4 == "Dalam Proses")
                                            @include('vkb-atasan-verifikator-4.modal-cek')
                                            <a href="{{ route('vkb-atasan-verifikator-4.show_v',$kasbon->id) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Kasbon"><i class="mdi mdi-information-outline" style="font-size: 150%;"></i></a>
                                            <a href="{{ route('vkb-atasan-verifikator-4.kelengkapan_v',$kasbon->id) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="List Kelengkapan"><i class="mdi mdi-file-document" style="font-size: 150%; "></i></a>
                                            <a href="{{ route('vkb-atasan-verifikator-4.dokumen',$kasbon->id) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Lampiran"><i class="mdi mdi-file-pdf" style="font-size: 150%; "></i></a>
