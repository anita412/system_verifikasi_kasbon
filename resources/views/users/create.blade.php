            ...
            <form action="{{ route('users.store') }}" method="post" class="form-parsley">
                ...
                <div class="row">
                    <div class="form-floating mb-3 col-lg-6">
                        ...
                        placeholder="Password" name="password" data-parsley-errors-container=".errorspannewpassinput"
                        data-parsley-pattern="(?=.*[a-z])(?=.*[A-Z]).*" data-parsley-minlength="6"
                        data-parsley-required-message="Please enter your new password." data-parsley-pattern-message=
                        "The password must contain at least 1 lower case letter [a-z], 1 upper case letter [A-Z] and 1 numeric character [0-9] "/>
