<div class="row"  id="form-entry-3">
    <div>
{{-- <input type="text" value="{{$detail}}" name="" id=""> --}}
{{-- <input type="text" value="{{$nonkasbon->dokumennonkasbon->id}}" name="" id=""> --}}
            <table class="table  table-bordered table-sm t1">
                ...
                <tr class="item">
                    ...
                    <td><input name="nominal[]" class="qnty amount form-control" value="{{$details->nominal}}" required parsley /></td>
                    <td class="text-end">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th>
                                <input id="netto" readonly="readonly" class="form-control"  name="total" type="text" value="{{$nonkasbon->dokumennk->total}}"></th>
                            <th></th>
                        </tr>
                    </tbody>
                        </tfoot>
