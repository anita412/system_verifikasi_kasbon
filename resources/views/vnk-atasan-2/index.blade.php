                                ...
                                <tr>
                                    ...
                                    @if($nonkasbon->verifikasinonkasbon->vnk_a_2 == "Dalam Proses")
                                        ...
                                        @elseif($nonkasbon->verifikasinonkasbon->vnk_a_2 == "Terverifikasi")
                                            <label class="badge rounded-pill bg-success">Verifikasi</label>
                                        @endif</td>
                                    <td class="text-end">
                                            @if($nonkasbon->verifikasinonkasbon->vnk_a_2 == "Dalam Proses")
                                            <a href={{ route('vnk-atasan-2.cek_nonkasbon_edit',$nonkasbon->id) }} class="btn btn-outline-primary btn-sm"><i class="mdi mdi-send me-2"></i>Cek nonkasbon</a> 
                                            @elseif($nonkasbon->verifikasinonkasbon->vnk_a_2 == "Terverifikasi")
                                            <a href={{ route('vnk-atasan-2.cek_nonkasbon_edit',$nonkasbon->id) }} class="btn btn-outline-success btn-sm"><i class="mdi mdi-send me-2"></i>Lihat nonkasbon</a> 
                                            @elseif($nonkasbon->verifikasinonkasbon->vnk_a_2 == "Ditolak")
                                            <a href={{ route('vnk-atasan-2.cek_nonkasbon_edit',$nonkasbon->id) }} class="btn btn-outline-danger btn-sm"><i class="mdi mdi-send me-2"></i>Lihat nonkasbon</a> 
                                            @elseif($nonkasbon->verifikasinonkasbon->vnk_a_2 == "Revisi")
                                            <a href={{ route('vnk-atasan-2.cek_nonkasbon_edit',$nonkasbon->id) }} class="btn btn-outline-warning btn-sm"><i class="mdi mdi-send me-2"></i>Lihat nonkasbon</a> 
                                            @endif
                                    </td>
                                    @endif
                                    @endforeach 
...
$('.filter-checkbox').on('change', function(e){
   ...
   document.getElementsByClassName("datesearchbox")[1].style.textAlign = "right";
