                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        @if(isset($nonkasbon->verifikasinonkasbon->id_vnk))
                                            ...
                                            @elseif($nonkasbon->verifikasinonkasbon->vnk == "Terverifikasi")
                                            <a href={{ route('vnk.cek_nonkasbon_edit',$nonkasbon->id) }} class="btn btn-outline-success btn-sm"><i class="mdi mdi-send me-2"></i>Lihat nonkasbon</a> 
                                            @elseif($nonkasbon->verifikasinonkasbon->vnk == "Ditolak")
                                            <a href={{ route('vnk.cek_nonkasbon_edit',$nonkasbon->id) }} class="btn btn-outline-danger btn-sm"><i class="mdi mdi-send me-2"></i>Lihat nonkasbon</a> 
                                            @elseif($nonkasbon->verifikasinonkasbon->vnk == "Revisi")
                                            <a href={{ route('vnk.cek_nonkasbon_edit',$nonkasbon->id) }} class="btn btn-outline-warning btn-sm"><i class="mdi mdi-send me-2"></i>Lihat nonkasbon</a> 
                                            @endif
                                        @else
                                            @if($nonkasbon->verifikasinonkasbon->vnk == "Dalam Proses")
                                            <a href={{ route('vnk.cek_nonkasbon',$nonkasbon->id) }} class="btn btn-outline-primary btn-sm"><i class="mdi mdi-send me-2"></i>Cek nonkasbon</a> 
                                            @elseif($nonkasbon->verifikasinonkasbon->vnk == "Terverifikasi")
