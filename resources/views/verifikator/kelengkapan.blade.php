                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body bootstrap-select-1">
                            <form  action="{{ route('verifikator.store', $kasbon->id) }}" method="post" class="form-parsley" >
                                <input value="{{$kasbon->id}}" class="text-muted mb-0" name="id" hidden>
                                {{ csrf_field() }}
                               @include('verifikator.dokumen-vendor')
                               @include('verifikator.dokumen-customer')
                               @include('verifikator.dokumen-impor')
                               @include('verifikator.dokumen-pajak')
                               @include('verifikator.dokumen-dinas')
                               @include('verifikator.keterangan')
                            </form>   
                        </div><!--end card-body-->
                    </div><!--end card-->
                </div><!--end col-->
