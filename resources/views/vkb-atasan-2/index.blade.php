                            ...
                            <table id="datatable2" class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @include('vkb-atasan-2.modal-cek-edit')
                                        @include('vkb-atasan-2.modal-cek-lihat')
                                            @if($kasbon->verifikasikasbon->vkb_a_2 == "Dalam Proses")
                                            <a data-bs-toggle="modal" data-bs-target="#modalcekedit_{{$kasbon->id}}" class="btn btn-outline-primary btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Kasbon</a> 
                                            @elseif($kasbon->verifikasikasbon->vkb_a_2 == "Terverifikasi")
                                            <a data-bs-toggle="modal" data-bs-target="#modalceklihat_{{$kasbon->id}}" class="btn btn-outline-success btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Kasbon</a> 
                                            @elseif($kasbon->verifikasikasbon->vkb_a_2 == "Ditolak")
                                            <a data-bs-toggle="modal" data-bs-target="#modalceklihat_{{$kasbon->id}}" class="btn btn-outline-danger btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Kasbon</a> 
                                            @elseif($kasbon->verifikasikasbon->vkb_a_2 == "Revisi")
                                            <a data-bs-toggle="modal" data-bs-target="#modalcekedit_{{$kasbon->id}}" class="btn btn-outline-warning btn-sm"><i class="mdi mdi-send me-2"></i>Lihat Kasbon</a> 
                                            @endif
                                        @else
                                        @include('vkb-atasan-2.modal-cek-edit')
                                            @if($kasbon->verifikasikasbon->vkb_a_2 == "Dalam Proses")
