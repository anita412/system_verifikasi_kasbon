...
class VerifikasiAtasanController extends Controller
{
    // function __construct()
    // {
    //     $this->middleware('permission:verifikasi-atasan-list|verifikasi-atasan-create|verifikasi-atasan-edit|verifikasi-atasan-delete|verifikasi-atasan-kelengkapan', ['only' => ['index', 'store']]);
    //     $this->middleware('permission:verifikasi-atasan-create', ['only' => ['create', 'store']]);
    //     $this->middleware('permission:verifikasi-atasan-edit', ['only' => ['edit', 'update']]);
    //     $this->middleware('permission:verifikasi-atasan-delete', ['only' => ['destroy']]);
    // }

    public function index(Request $request)
    {
        $kelengkapan = Kelengkapan::where('status', 'Terverifikasi')->get();
        $title = 'Kasbon';
        return view('verifikasi-atasan.index', compact('kelengkapan', 'title'))
    ...
    public function edit($id)
    {
        ...
        $title = 'Detail';
        return view('verifikasi-atasan.edit', compact('title', 'kelengkapan'));
    }
    ...
    public function info($id)
    {
        ...
        $user = User::all();
        $title = 'Detail';
        return view('verifikasi-atasan.edit-info', compact('title', 'kasbon', 'pph', 'kurs', 'jenis', 'user', 'kodekasbon', 'kelengkapan'));
    }
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('verifikasi-atasan.index')
    ...
    public function cek_kelengkapan($id)
    {
        $kelengkapan = Kelengkapan::find($id);
        $kd = $kelengkapan->keterangan->id;
        ...
        return view('verifikasi-atasan.kelengkapan', compact('title', 'kelengkapan', 'detail'));
    }
    ...
    public function keterangan($id)
    {
        ...
        return view('verifikasi-atasan.keterangan', compact('title', 'kelengkapan', 'detail'));
    }
    ...
    public function kelengkapan_edit($id)
    {
        ...
        return view('verifikasi-atasan.edit-kelengkapan', compact('title', 'kelengkapan', 'detail'));
    }
